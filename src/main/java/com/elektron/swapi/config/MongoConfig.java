...
/**
 * Configuração responsável pelos dados de conexão com o banco de dados
 * @author Edmilson Pontes
 * @email edmilsonspontes@gmail.com 
 * @github https://github.com/edmilsonspontes
 */
@Configuration
@EnableMongoRepositories(basePackages = "com.elektron.swapi.repository")
public class MongoConfig extends AbstractMongoClientConfiguration {
	...
	public Collection getMappingBasePackages() {
		return Collections.singleton("com.elektron.swapi");
	}
